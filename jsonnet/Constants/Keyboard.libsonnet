  ...
  keyboard: {
    ...
    qButton: {
      ...
      params: {
        ...
        swipeUp: { action: { character: '!' } },swipeDown: { action: { character: '1' } },
      },
    },
    wButton: {
      name: 'wButton',
      params: {
        ...
        swipeUp: { action: { character: '@' } },swipeDown: { action: { character: '2' } },
      },
    },
    eButton: {
      name: 'eButton',
      params: {
        ...
        swipeUp: { action: { character: '#' } },swipeDown: { action: { character: '3' } },
      },
    },
    rButton: {
      name: 'rButton',
      params: {
        ...
        swipeUp: { action: { character: '$' } },swipeDown: { action: { character: '4' } },
      },
    },
    tButton: {
      name: 'tButton',
    ...
    yButton: {
      ...
      params: {
        ...
        swipeUp: { action: { character: '^' } },swipeDown: { action: { character: '6' } },
      },
    },
    uButton: {
      name: 'uButton',
      params: {
        ...
        swipeUp: { action: { character: '&' } },swipeDown: { action: { character: '7' } },
      },
    },
    iButton: {
      name: 'iButton',
...
asciiModeButton: {
  ...
  candidateStyle: {
    ...
    //colors.candidateForegroundColor,
